...
public:
	...
	uint8_t TFTdrawChar(uint16_t x, uint16_t y, uint8_t c, uint16_t color, uint16_t bg, uint8_t size);
	uint8_t TFTdrawText(uint16_t x, uint16_t y, char *_text, uint16_t color, uint16_t bg, uint8_t size);
	uint8_t TFTdrawChar(uint16_t x, uint16_t y, uint8_t c, uint16_t color, uint16_t bg);
	uint8_t TFTdrawText(uint16_t x, uint16_t y, char *pText, uint16_t color, uint16_t bg);
	void setTextColor(uint16_t c);
	void setTextColor(uint16_t c, uint16_t bg);
	void setTextSize(uint8_t s);

	// Bitmap & Icon
	uint8_t TFTdrawIcon(uint16_t x, uint16_t y, uint16_t w, uint16_t color, uint16_t bgcolor, const unsigned char character[]);
